...
public class regExActivity {
    ...
    public static void username()throws IOException, FileNotFoundException{
        ...
        */
        File file = new File("C:\\Users\\Owner\\OneDrive\\Documents\\week 6\\week 6\\src\\username.txt");
        BufferedReader br = new BufferedReader (new FileReader(file));
        String pattern = "^([a-z-0-9_-]){8,24}$"; //insert regex here
        String text;
    ...
    public static void email()throws IOException, FileNotFoundException{
        ...
        */
        File file = new File("C:\\Users\\Owner\\OneDrive\\Documents\\week 6\\week 6\\src\\email.txt");
        BufferedReader br = new BufferedReader (new FileReader(file));
    ...
    public static void findPanda()throws IOException, FileNotFoundException{
        ...
        */
        File file = new File("C:\\Users\\Owner\\OneDrive\\Documents\\week 6\\week 6\\src\\panda.txt");
        BufferedReader br = new BufferedReader (new FileReader(file));
